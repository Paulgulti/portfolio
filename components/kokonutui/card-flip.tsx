...
export default function CardFlip({ certificateIndex, certificates }: { certificateIndex: number; certificates: CardFlipProps[] }) {
  const [isFlipped, setIsFlipped] = useState(false);

  return (
    <div
      className="group relative h-70 md:h-80 w-full max-w-55 md:max-w-70  [perspective:2000px]"
      ...
      >
        ...
        >
          <div className="relative h-full overflow-hidden bg-gradient-to-b from-zinc-100 to-white dark:from-zinc-900 dark:to-black">
            <div className=" absolute inset-0 flex items-start md:pt-10 justify-center ">
              ...
              <Image
                ...
                width={250}
                height={250}
                src={certificates[certificateIndex].img}
                alt="hgj" />
            </div>
          </div>
          <div className="absolute right-0 bottom-10 md:bottom-5 left-0 px-5">
